...
#Rumus enkripsi vigenere cipher :Pi = (Ci-Ki) mod 26 atauCi = ( Pi + Ki ) – 26, kalau hasil penjumlahan Pi dan Ki lebih dari 26
#Enkripsi ini menggunakan plaintext pada kolom, serta kunci pada baris Kombinasi keduanya akan menghasilkan cipher pada baris dan kolom yang dipilih.
...
#Dekripsi yaitu kebalikan dari proses enkripsi yaitu proses konversi data yang sudah dienkripsi .
#Rumus dekripsi vigenere cipher : Pi = (Ci-Ki) mod 26atauPi = ( Ci – Ki ) + 26, kalau hasil pengurangan Ci dengan Ki minus
